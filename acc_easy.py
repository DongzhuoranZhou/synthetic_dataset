...
if __name__ == '__main__':
    ...
    num_layers_lst = [6,7, 9, 11, 13, 14, 15, 16, 18, 19, 21, 23, 25, 27, 29, 31, 33,35]
    root = 'logs/DeepLayers/ChangingLayersPlus3/dataset_syn2/width_1/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    # num_layers_lst = [3, 4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32] + 8
    num_layers_lst = [11, 12, 14,  16, 18, 19, 20, 21, 22,23, 24, 26, 28, 30, 32, 34, 36, 38, 40]
    root = 'logs/DeepLayers/ChangingLayersPlus8/dataset_syn2/width_1/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 5)
    root = 'logs/DeepLayers/ChangingLayersPlus5/dataset_syn2/width_1/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'


    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 8)
    root = 'logs/DeepLayers/ChangingLayersPlus8/dataset_syn2/width_1/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 12)
    root = 'logs/DeepLayers/ChangingLayersPlus12/dataset_syn2/width_1/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'


    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 3)
    root = 'logs/DeepLayers/ChangingLayersPlus3/dataset_syn2/width_2/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 5)
    root = 'logs/DeepLayers/ChangingLayersPlus5/dataset_syn2/width_2/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    # num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    # num_layers_lst = np.add(num_layers_lst, 8)
    # root = 'logs/DeepLayers/ChangingLayersPlus8/dataset_syn2/width_2/hdim16'
    # num_layers = '_3_32'
    # dataset = 'syn2'

    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 12)
    root = 'logs/DeepLayers/ChangingLayersPlus12/dataset_syn2/width_2/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 3)
    root = 'logs/DeepLayers/ChangingLayersPlus3/dataset_syn2/width_3/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 5)
    root = 'logs/DeepLayers/ChangingLayersPlus5/dataset_syn2/width_3/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 8)
    root = 'logs/DeepLayers/ChangingLayersPlus8/dataset_syn2/width_3/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = np.array([3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32])
    num_layers_lst = np.add(num_layers_lst, 12)
    root = 'logs/DeepLayers/ChangingLayersPlus12/dataset_syn2/width_3/hdim16'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = [3,4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32,34,36,38,40]
    root = 'logs/DeepLayers/FixedLayers16/dataset_syn2/width_1/hdim16'
    num_layers = '_3_40'
    dataset = 'syn2'
    ...
    num_layers_lst = [3, 4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32]
    root = 'logs/withnoise/withnoise/Time2/dataset_syn2/width_1/hdim16/direction_directed'
    num_layers = '_3_32'
    dataset = 'syn2'

    num_layers_lst = [3, 4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 22, 24, 26, 28, 30, 32]
    root = 'logs/withnoise/withnoise/Time3/dataset_syn2/width_1/hdim16/direction_undirected'
    num_layers = '_3_32'
    dataset = 'syn2'
    ...
    G2_GNN_hdim16_acc_dict = torch.load(
        '{}/Model_G2_GNN_Norm_None_Trick_None/G2_GNN{}layers_{}_summary.pt'.format(root, num_layers, dataset))
    G2_GNN_hdim16_TrainTestDataContainer = plot_data_preprocess(G2_GNN_hdim16_acc_dict, num_layers_lst,
                                                               label='G2_GNN_hdim{}'.format(hdim))
    ...
    # list_container = [GAT_hdim16_TrainTestDataContainer,GAT_hdim16_pair_TrainTestDataContainer,GAT_hdim16_group_TrainTestDataContainer,GAT_hdim16_batch_TrainTestDataContainer] # GAT_hdim16_batch_TrainTestDataContainer
    # list_container = [GAT_hdim16_TrainTestDataContainer]
    ...
    list_container = [G2_GNN_hdim16_TrainTestDataContainer]
    ...
    # list_container = [SGC_hdim16_pair_TrainTestDataCdontainer,SGC_hdim16_TrainTestDataContainer,SGC_hdim16_group_TrainTestDataContainer,SGC_hdim16_batch_TrainTestDataContainer]
    ...
    # acc_type_list = ['test']
    # acc_type_list = ['test']
    title = "{} accuracy, alpha = 3,  Undirected Graph, Width = 1, with Noise".format(' '.join(acc_type_list))
